...
object EasterEggManager {
    ...
    val loveWords = listOf(
        ...
        // —— 四季情话 ——
        LoveWord("🌷", "春天来了", "春风吹过的时候，\n我闻到了花香，\n也闻到了想你的味道。\n\n春天真好，\n因为又可以和你一起赏花了。"),
        LoveWord("🌱", "发芽的心", "春天万物复苏，\n我对你的爱也在疯狂生长。\n\n从一颗种子，\n长成了参天大树。"),
        LoveWord("☀️", "夏日冰饮", "夏天太热了，\n但和你在一起，\n心里却凉凉的、甜甜的。\n\n像喝了一杯冰柠檬水。"),
        LoveWord("🍉", "西瓜味的夏天", "夏天就该吃西瓜，\n最中间最甜的那一口，\n永远留给你。\n\n这是我的夏日仪式感。"),
        LoveWord("🍂", "秋天的第一杯奶茶", "秋天的第一杯奶茶，\n当然要和你一起喝。\n\n三分糖就够了，\n因为有你已经很甜。"),
        LoveWord("🍁", "落叶归根", "秋天的落叶飘啊飘，\n最后都落在了地上。\n\n就像我兜兜转转，\n最后还是回到你身边。"),
        LoveWord("⛄", "冬日暖阳", "冬天最想做的事，\n就是和你窝在沙发上，\n盖一条毯子，\n看一部老电影。\n\n外面再冷，心里都是暖的。"),
        LoveWord("🧤", "手套给你", "冬天出门忘了戴手套？\n没关系，\n把手给我，\n我帮你捂热。\n\n我的手永远为你留着温度。"),

        // —— 节日情话 ——
        LoveWord("🎄", "圣诞快乐", "圣诞老人问我想要什么礼物，\n我说不用了，\n\n因为最好的礼物，\n已经在我身边了。"),
        LoveWord("🎆", "新年快乐", "新年的钟声响起时，\n我许的愿望和去年一样：\n\n和你在一起，\n一年又一年。"),
        LoveWord("🏮", "元宵节", "元宵节的灯笼再亮，\n也没有你的眼睛亮。\n\n猜灯谜的答案只有一个：\n我爱你。"),
        LoveWord("🎋", "七夕", "牛郎织女一年见一次，\n而我每天都想见你。\n\n所以我比牛郎幸福多了。"),
        LoveWord("🎂", "生日快乐", "生日蛋糕上的蜡烛，\n我帮你吹。\n\n许愿的时候别说出来，\n但我猜一定和我有关吧。"),

        // —— 美食情话 ——
        LoveWord("🍜", "一碗热汤面", "天冷的时候，\n最想给你煮一碗热汤面。\n\n加花，\n满满都是爱你的味道。"),
        LoveWord("🧁", "甜品时间", "你就像提拉米苏，\n一层一层都是甜蜜。\n\n每一口都让我上瘾，\n怎么吃都吃不够。"),
        LoveWord("☕", "咖啡与你", "你就像我的咖啡，\n苦的时候有你就变甜了。\n\n每天一杯，\n已经成了习惯。"),
        LoveWord("🍕", "一起吃披萨", "披萨要趁热吃，\n就像爱你这件事，\n一刻都不想等。\n\n芝士拉丝的瞬间，\n像极了我们分不开的样子。"),

        // —— 旅行情话 ——
        LoveWord("⛰️", "一起爬山", "和你一起爬山，\n不在乎山顶的风景，\n\n在乎的是你气喘吁吁\n还要牵着我的手。"),
        LoveWord("🌅", "看日出", "想和你一起看日出，\n在山顶，在海边，\n在任何有你的地方。\n\n第一缕阳光照在你脸上，\n那就是我见过最美的画。"),
        LoveWord("✈️", "下一站", "我的旅行清单上，\n每一个目的地旁边，\n都写着你的名字。\n\n因为没有你的旅行，\n不算旅行。"),
        LoveWord("⭐", "看星星", "想和你去没有灯光的地方，\n躺在草地上看星星。\n\n数到第一百颗的时候，\n转头看你，\n你比星星还耀眼。"),

        // —— 日常甜蜜 ——
        LoveWord("🛏️", "赖床", "周末最幸福的事，\n就是赖在床上不起来，\n\n然后你凑过来说：\n「再睡五分钟。」\n\n五分钟又五分钟。"),
        LoveWord("🚗", "接你下班", "在公司楼下等你的时候，\n看到你从门口走出来，\n\n那一刻觉得，\n等再久都值得。"),
        LoveWord("🛒", "逛超市", "和你逛超市，\n你往购物车里放零食，\n我往购物车里放你。\n\n这就是我最想要的日常。"),
        LoveWord("📱", "等你回消息", "你回消息慢的时候，\n我会反复看聊天记录。\n\n看着看着就笑了，\n因为每一条都好甜。"),
        LoveWord("🎮", "一起打游戏", "和你打游戏，\n赢了我开心，\n输了你开心。\n\n怎么算都是开心的。"),

        // —— 电影/音乐情话 ——
        LoveWord("🎬", "一起看电影", "看恐怖片的时候，\n你躲在我怀里。\n\n其实我也害怕，\n但有你在，\n就什么都不怕了。"),
        LoveWord("🎧", "单曲循环", "最近单曲循环一首歌，\n因为歌词写的就是我们。\n\n每一句都像是\n我想对你说的话。"),
        LoveWord("🎹", "弹给你听", "如果我会弹钢琴，\n一定给你弹一首情歌。\n\n不会也没关系，\n我用心跳给你打节拍。"),

        // —— 未来畅想 ——
        LoveWord("💍", "嫁给我吧", "等到那一天，\n我会单膝跪地，\n把戒指戴在你手上。\n\n然后说：\n余生请多指教。"),
        LoveWord("🐶", "养一只狗", "以后我们养一只狗吧，\n你遛狗，我遛你。\n\n三个人一起散步，\n想想就觉得幸福。"),
        LoveWord("🪴", "阳台花园", "以后我们的阳台上，\n要种满花花草草。\n\n你浇水，我施肥，\n一起看它们开花。"),
        LoveWord("💌", "写给未来的信", "亲爱的未来的你：\n\n不管过了多少年，\n我还是会像现在一样爱你。\n\n这是我最认真的承诺。"),
        LoveWord("🎪", "游乐园之约", "下次去游乐园，\n我要和你坐摩天轮。\n\n在最高点的时候亲你一下，\n这是摩天轮的规矩。")
    )
    ...
    val egg666 = LoveWord("🎰", "666大顺", "666 = 一切顺利\n\n有你在身边，\n做什么都顺顺利利。\n\n你就是我的幸运符。")
    val egg888 = LoveWord("🧧", "发发发", "888 = 发发发\n\n不用发大财，\n只要有你就是最大的财富。\n\n你比金子还珍贵。")
    val egg233 = LoveWord("😂", "笑死我了", "233 = 哈哈哈\n\n和你在一起的每一天，\n都充满了欢笑。\n\n你是我的快乐源泉。")
    val egg521 = LoveWord("💘", "521", "521 = 我爱你\n\n不止521，\n365天每一天都爱你。\n\n爱你是我最擅长的事。")
    val eggMorning = LoveWord("🌅", "早安宝贝", "新的一天开始了，\n第一件事就是想你。\n\n希望你今天也元气满满，\n记得吃早餐哦。\n\n早安，我最爱的人。")
    val eggNight = LoveWord("🌃", "晚安宝贝", "忙碌的一天结束了，\n辛苦了，宝贝。\n\n今晚做个好梦，\n梦里有我就更好了。\n\n晚安，明天见。")
    val eggWeekend = LoveWord("🎡", "周末快乐", "终于到周末了！\n\n想和你一起赖床，\n一起看电影，\n一起吃好吃的。\n\n周末的意义就是和你在一起。")
    val eggRain = LoveWord("🌧️", "下雨天", "外面下雨了，\n你带伞了吗？\n\n如果没有，\n就在原地等我，\n我去接你。")
    ...
    fun seasonalLoveWord(): LoveWord {
        ...
        val seasonWords = when (month) {
            3, 4, 5 -> loveWords.filter { it.emoji in listOf("🌸", "🌻", "🌈", "🌷") }
            6, 7, 8 -> loveWords.filter { it.emoji in listOf("☀️", "🍦", "🌊", "🎪") }
            9, 10, 11 -> loveWords.filter { it.emoji in listOf("🍂", "🧣", "🎵", "🍰") }
            else -> loveWords.filter { it.emoji in listOf("🧣", "🌙", "☕", "🎄") }
        }
    ...
    fun timeLoveWord(): LoveWord {
        ...
        return when {
            ...
            hour in 12..13 -> LoveWord("🍱", "午餐时间", "中午了，记得吃饭哦。\n\n不管吃什么，\n想到你也在吃饭，\n就觉得很幸福。")
            hour in 14..17 -> loveWords.random()
            hour in 18..20 -> LoveWord("🌆", "下班啦", "下班了！\n\n今天辛苦了，\n回家的路上注意安全。\n\n到家告诉我一声哦。")
            hour in 21..23 -> eggNight
            else -> LoveWord("🌙", "深夜情话", "这么晚了还没睡？\n\n快去睡觉，\n不然明天会有黑眼圈的。\n\n做个好梦，梦里有我。")
        }
    }
    ...
    fun getLoveWordCategories(): Map<String, List<LoveWord>> {
        return mapOf(
            "日常甜蜜" to loveWords.filter { it.emoji in listOf("💕", "☀️", "🧸", "🍦", "🎁", "💫", "🎈") },
            "四季情话" to loveWords.filter { it.emoji in listOf("🌸", "🌻", "🍂", "🧣", "🌊", "☀️") },
            "美食情话" to loveWords.filter { it.emoji in listOf("🍳", "🍰", "🍦", "☕", "🍱") },
            "浪漫时刻" to loveWords.filter { it.emoji in listOf("🌙", "✨", "🎵", "📷", "🎠", "🌈") },
            "未来畅想" to loveWords.filter { it.emoji in listOf("🏠", "💍", "🐱", "🎪", "💌") },
            "全部情话" to loveWords
        )
    }
}
