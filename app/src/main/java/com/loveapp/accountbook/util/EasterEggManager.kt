...
object EasterEggManager {
    ...
    val loveWords = listOf(
        ...
        // —— 专属情话 ——
        LoveWord("heart", "顾丁一家", "顾名思义就是回头看，\n我一回头就看见了你。\n\n从此顾先生的心里，\n只住着丁姐姐一个人。"),
        LoveWord("shine", "小老鼠和小鸡仔", "你是96的小老鼠，\n我是05的小鸡仔。\n\n老鼠爱大米，\n可我这只老鼠只爱你。"),
        LoveWord("heart", "丁宝贝", "丁宝贝，\n你的姓氏有个口，\n刚好用来亲一下。\n\n每天亲一次，\n一天都不想落下。"),
        LoveWord("heart", "我的小仙女", "全世界那么多姓丁的，\n我只喜欢你这一个。\n\n其他人叫丁同学，\n我叫你宝贝。"),

        // —— 感恩她的照顾 ——
        LoveWord("heart", "有你真好", "我知道我很懒，\n但你从来不嫌弃我。\n\n谢谢你一直照顾我，\n下辈子换我宠你。"),
        LoveWord("shine", "你的手", "你的手最神奇，\n按在我肩上就能把\n一天的累都化掉。\n\n我愿意为了这双手，\n累一辈子。"),
        LoveWord("bear", "小懒虫的忠告", "我承认我懒，\n但我对你不懒。\n\n想你这件事，\n我从来都很勤快。"),
        LoveWord("heart", "最好的你", "别人家的女朋友只会撤娇，\n我家的丁宝贝\n会给我按摩、做饭、\n还会宠我。\n\n我是不是上辈子\n拯救了银河系？"),
        LoveWord("gift", "你的温柔", "你对我的好，\n我全部记在心里。\n\n每一次照顾，\n都让我更确定：\n这辈子非你不可。"),

        // —— 表白情话 ——
        LoveWord("heart", "三件事", "我这辈子只想做三件事：\n\n你、你、还是你。"),
        LoveWord("shine", "我的答案", "人家的小作文写\n“我的梦想”，\n\n我的梦想只有两个字：\n你。"),
        LoveWord("heart", "最好的安排", "你比我小九岁，\n刚好够我宠一辈子。\n\n不对，\n就算同岁我也宠。"),
        LoveWord("moon", "深夜想你", "深夜的时候最想你，\n想你的脸，想你的声音，\n想你躬在我怀里的样子。\n\n想着想着就笑了。"),
        LoveWord("heart", "我的世界", "认识你之前，\n我的世界是黑白的。\n\n认识你之后，\n全部变成了粉色。"),
        LoveWord("shine", "喜欢你的理由", "喜欢你不需要理由，\n但如果非要一个：\n\n因为是你。"),
        LoveWord("heart", "不讲道理", "喜欢你这件事，\n不讲道理、不计成本、\n不问前程。\n\n反正我就是喜欢你。"),

        // —— 撩人情话 ——
        LoveWord("moon", "想抱你", "此刻只想把你\n紧紧摤在怀里，\n闻你头发的香味，\n亲你的额头。\n\n然后再亲一下嘴唇。"),
        LoveWord("heart", "你的唇", "你不许抓开我的手，\n不许逼我放开你，\n\n更不许在我想亲你的时候\n躁开。"),
        LoveWord("moon", "晚上的想念", "每到晚上就特别想你，\n想和你贴在一起，\n感受你的体温。\n\n你身上最让我上癸的，\n是你的味道。"),
        LoveWord("heart", "想你的身体", "想你的时候，\n不只是想你的人，\n还想你的唇、你的腰、\n你躬在我身上的样子。\n\n我贪心，我全都要。"),
        LoveWord("moon", "最喜欢的姿势", "最喜欢你缩在我怀里，\n两只手绕着我的腰，\n脸埋在我胸口。\n\n这个位置永远为你留着。"),
        LoveWord("heart", "你的按摩", "你给我按摩的时候，\n我不只是舒服，\n还有点想羻过来\n把你按在身下。\n\n你说怕不怕？"),
        LoveWord("shine", "随时随地", "谢谢你总是\n满足我所有的任性。\n\n每一次你都让我觉得，\n我是世界上\n最幸福的人。"),
        LoveWord("moon", "今晚想你", "今天工作好累，\n只想回家躬在你身上，\n什么都不做，\n只要你。\n\n或者……做点什么也行。"),
        LoveWord("heart", "睡前情话", "睛开眼第一个想见的人是你，\n闭上眼最后一个想的人也是你。\n\n中间做梦的时候，\n梦里还是你。"),
        LoveWord("shine", "小老鼠喊饱了", "你喂我吃饭，\n喂我吃零食，\n还喂我吃亲亲。\n\n这只小老鼠被你\n喂得圆滚滚的，\n全是爱。"),
        LoveWord("heart", "不想起床", "周末赖床的时候，\n你就窝在我怀里。\n\n这个世界上\n没有任何闹钟，\n能把我从你身边叫走。"),
        LoveWord("heart", "全部给你", "我的心、我的人、\n我的钱包、我的密码、\n我的一切。\n\n全部是你的，\n别客气。"),
        LoveWord("shine", "你的味道", "你身上有种味道，\n闻一口就上瘦。\n\n不是香水，\n是你。\n\n让我再闻闻。"),
        LoveWord("heart", "我的软肋", "你是我唯一的软肋，\n也是我所有的铠甲。\n\n为了你我可以\n变得很勇敢，\n也可以变得很温柔。"),

        // —— 更多专属情话 ——
        LoveWord("heart", "顾名思义", "顾，回头看的意思。\n\n所以我这辈子做的最对的事，\n就是回头看了你一眼。\n\n然后就再也移不开了。"),
        LoveWord("heart", "丁是丁香", "丁香花的花语是永恒的爱。\n\n而我的丁丁，\n比丁香花还香。"),
        LoveWord("shine", "鼠和鸡", "人家说鼠和鸡不合，\n我就偏要和你在一起。\n\n我偏不信命，\n只信你。"),
        LoveWord("heart", "两个字", "顾和丁，\n加在一起刚好两个字。\n\n刚好是一对，\n刚好是一辈子。"),

        // —— 宠溪系列 ——
        LoveWord("bear", "你的手心", "你给我按摩的时候，\n我就觉得\n世界上最温柔的东西，\n\n不是棉花，\n是你的手心。"),
        LoveWord("home", "偷懒的我", "我知道我很懒，\n但有一件事我很勤快：\n\n爱你。\n\n每天都在认真的爱你。"),
        LoveWord("shine", "全世界最好的你", "谢谢你愿意照顾懒懒的我，\n不嫌我烦，不嫌我吁。\n\n下辈子换我照顾你，\n好不好？"),
        LoveWord("bear", "人形枕头", "我最喜欢的睡姿，\n是抱着你。\n\n你是我专属的\n人形枕头，\n谁也不许抢。"),
        LoveWord("heart", "小储钱罐", "我的钱都是你的，\n我的人也是你的。\n\n反正我整个人\n都是你的小储钱罐。"),

        // —— 调皮情话 ——
        LoveWord("moon", "晚上想你", "关了灯以后，\n满脑子都是你。\n\n想你的脸，想你的嘴唇，\n想你赖在我身上的样子。"),
        LoveWord("heart", "三个上瘦", "我对你有三个上瘦的地方：\n\n你的脸，\n你的嘴，\n你的温度。"),
        LoveWord("shine", "非你不可", "这个世界上\n别的我都可以将就，\n\n只有你，\n非你不可。"),
        LoveWord("moon", "睡前想你", "每天最后一个想法是你，\n每天第一个想法还是你。\n\n我的脑子里\n全是你的名字。"),
        LoveWord("heart", "抱紧一点", "我喜欢抱你的时候，\n你把头埋在我胸口。\n\n那一刻\n感觉整个世界都是安静的。"),
        LoveWord("heart", "我都依你", "你说向东我不向西，\n你说想我我就出现，\n\n你说要我，\n我立刻就在。"),
        LoveWord("shine", "小鸡和老鼠", "小鸡找米吃，\n老鼠赖着不动。\n\n小鸡心软了，\n叼一块丢到嘴边。\n\n谁让老鼠这么可爱呢。"),
        LoveWord("heart", "只想赖着你", "你问我会什么，\n我会爱你，\n还会赖你。\n\n这两项\n我都第一名。"),

        // —— 撩人情话 ——
        LoveWord("moon", "没有分寸", "和你在一起的时候，\n我的手总是不听话。\n\n它只想摸你的脸，\n揽你的腰，\n把你拉得再近一点。"),
        LoveWord("heart", "贪心", "亲一口不够，\n抱一下不够，\n看一眼也不够。\n\n对你的贪心，\n没有尽头。"),
        LoveWord("moon", "想被你抱着睡", "今晚想被你抱着睡，\n被子上只要有你的体温，\n\n就是最安心的安眠毯。"),
        LoveWord("shine", "满分", "你的脸我想亲，100分。\n你的腰我想摸，100分。\n你的人我想要，100分。\n\n你在我心里，\n永远满分。"),
        LoveWord("heart", "还想要", "每次亲完你，\n你都会偷笑。\n\n然后我就忍不住\n又亲了一口。\n\n你的嘴唇是我的糖。"),
        LoveWord("moon", "夜里的情话", "白天我装得很正经，\n晚上就只想赖在你身上。\n\n你是我最喜欢的\n人形沙发。"),
        LoveWord("heart", "小野猫", "表面乖乖的，\n其实就是一只小野猫。\n\n只在你面前，\n才露出爪子。"),
        LoveWord("shine", "满身都是你", "你亲过的地方\n都还留着你的温度。\n\n我的嘴唇、我的脖子、\n我的整个人，\n都是你的。"),
        LoveWord("heart", "无法拒绝你", "你说想要的时候，\n我的心跳就开始加速。\n\n明知道你在撇娇，\n我还是全盘接收。"),
        LoveWord("moon", "只给你", "我的温柔只给你，\n我的不耐烦只给你，\n我的所有只给你。\n\n你要就来拿。"),

        // —— 更多通用情话 ——
        LoveWord("heart", "世界第八大奇迹", "世界七大奇迹我都没兴趣，\n\n因为第八大奇迹\n是你。"),
        LoveWord("shine", "你的名字", "我练了一万遍你的名字，\n写在纸上，画在心里。\n\n丁丁丁丁丁…\n写多少遍都不够。"),
        LoveWord("heart", "第一眼", "第一眼看到你的时候，\n我就知道完了。\n\n从此以后，\n心里再也装不下别人了。"),
        LoveWord("gift", "发抱抱报告", "今日抱抱已发放。\n\n收件人：丁丁\n发件人：想你的顾顾\n内容：无限抱紧。"),
        LoveWord("heart", "官方认证", "顾先生的心\n已被丁小姐正式认领。\n\n有效期：永久\n退换：不接受"),
        LoveWord("shine", "小幸运", "别人抽奖靠手气，\n我抽中了你靠运气。\n\n全世界最大的奖，\n就是遇见你。"),
        LoveWord("heart", "糟糕的我", "我不会做饭，不会打扫，\n不会早起，不会撒娇…\n\n好吧最后一个我会。\n但只对你。"),
        LoveWord("shine", "超能力", "如果我有超能力，\n我要技能“时间停止”。\n\n然后每天\n多看你一万秒。"),
        LoveWord("heart", "微信置顶", "你永远是我微信置顶的人。\n\n每次打开手机，\n第一个看的就是你。"),
        LoveWord("heart", "回家", "以前回家是回一个地方，\n现在回家是回到你身边。\n\n你在哪里，\n家就在哪里。")
    )
